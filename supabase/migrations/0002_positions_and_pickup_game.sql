...
create table public.pickup_game_contributions (
...
create index pickup_game_contributions_status_idx on public.pickup_game_contributions (status);

alter table public.pickup_game_contributions enable row level security;

create policy pickup_game_contributions_admin_all on public.pickup_game_contributions
