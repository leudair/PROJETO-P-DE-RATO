...
-- publico chamado "public" (criado manualmente no dashboard — ver README);
-- aqui so guardamos a URL publica resultante.

alter table public.team_settings add column banner_image_url text;
